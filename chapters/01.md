...
## Next up
Now that we've introduced the basic concepts of Reinforcement Learning and how they apply to LLMs, in the next chapter, we'll explore Verifiers, a library that makes it easy to build RL environments for training and evaluating Language Models.
